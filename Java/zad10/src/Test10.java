...
public class Test10 {
  public static void main(String[] args) {
    ...
    if (reszta.stream().mapToInt(Pieniadz::wartosc).sum() != 1)
      throw new RuntimeException("Nieprawidlowa reszta 1");
    ...
    if (reszta.stream().mapToInt(Pieniadz::wartosc).sum() != 499 + 500)
      throw new RuntimeException("Nieprawidlowa reszta2");
    ...
    if (reszta.stream().mapToInt(Pieniadz::wartosc).sum() != 5)
      throw new RuntimeException("Nieprawidlowa reszta3");
    razem.addAll(reszta);
    ...
    if (reszta.stream().mapToInt(Pieniadz::wartosc).sum() != 15)
      throw new RuntimeException("Nieprawidlowa reszta4");
    ...
    if (reszta.stream().mapToInt(Pieniadz::wartosc).sum() != 11 + 20)
      throw new RuntimeException("Nieprawidlowa reszta5");
    ...
    kasa = k.stanKasy();
    if (reszta.size() != 0)
      throw new RuntimeException("Nieprawidlowa reszta6");
    ...
    if (reszta.stream().mapToInt(Pieniadz::wartosc).sum() != 4 + 10)
      throw new RuntimeException("Nieprawidlowa suma reszty7a");
    ...
    if (reszta.stream().mapToInt(Pieniadz::wartosc).sum() != 10 + 5)
      throw new RuntimeException("Nieprawidlowa suma reszty7 "+ reszta.stream().mapToInt(Pieniadz::wartosc).sum());
    ...
    if (reszta.stream().mapToInt(Pieniadz::wartosc).sum() != 20 + 11)
      throw new RuntimeException("Nieprawidlowa suma reszty8 " + reszta.stream().mapToInt(Pieniadz::wartosc).sum());
    if (kasa.stream().mapToInt(Pieniadz::wartosc).sum() != 5)
      throw new RuntimeException("Nieprawidlowa kasa8");
    r.serialNumberCheck2(kasa, reszta);
